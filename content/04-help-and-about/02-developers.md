...
*Design and Development for Engineering and Manufacturing T Level → Developers*
...
- Source code: [github.com/lana6478/T-level-Design-Development-Engineering-Manufacturing](https://github.com/lana6478/T-level-Design-Development-Engineering-Manufacturing)

Found a mistake, an out-of-date detail, or want a topic covered in more depth? Open an [issue](https://github.com/lana6478/T-level-Design-Development-Engineering-Manufacturing/issues) on GitHub, or email directly - both are welcome.
...
This project paraphrases and reorganises the official T Level Technical Qualification in Design and Development for Engineering and Manufacturing specification (City & Guilds, v1.5, March 2026), Mechanical Engineering pathway, for easier navigation. It is unofficial and unaffiliated with City & Guilds or the Institute for Apprenticeships and Technical Education (IfATE). See [Sources and Further Reading](../sources-and-further-reading.md) for the primary, authoritative documents.
