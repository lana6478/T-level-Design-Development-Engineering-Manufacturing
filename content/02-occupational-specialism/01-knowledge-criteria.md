...
*Design and Development for Engineering and Manufacturing T Level → Occupational Specialism → Knowledge Criteria*

This page covers **Outcome 1: Common knowledge criteria** for the Mechanical Engineering specialism - the underpinning knowledge that supports all five Performance Outcomes (analysing requirements, evaluating designs, proposing solutions, collaborating, and communicating - see [Practical Criteria](02-practical-criteria.md)). Subsection numbers (1.1, 1.2...) mirror the specification.

## 1.1 Principles of engineering design

Covers requirements (functionality, aesthetics, dimensions, ergonomics, safety, sustainability, cost, materials), how requirements are identified (market research, client interviews/observation, product analysis) and recorded (design briefs, specifications, questionnaires, observational records), factors that affect design (product life cycle, sustainability, safety), the fields within mechanical engineering (design; manufacture and processing; fitting and assembly maintenance), and ways of communicating designs (orthographic drawings, virtual models, physical models).

Learners need to know how to agree the scope of a project, identify/confirm/record client requirements accurately, evaluate and develop those requirements, and communicate design ideas and technical information clearly - including the tools available for recording and developing requirements.
...
Covers the characteristics of orthographic drawings (sheet size, section views/hatching), and the information conveyed by drawings (standard features like springs, splines, gears, webs, solid shafts, keys/keyways; mechanical symbols like balloon, diameter, depth). Learners need to know the purpose and audience of different drawing types, and how to interpret the symbols, conventions and annotations used in BS EN 8888.

## 1.4 Standards and regulatory requirements
...
Covers gear ratio, velocity ratio, mechanical advantage, efficiency, stress, strain, pressure, density, velocity and acceleration. Learners need to be able to calculate these in relation to resource requirements, material properties, mechanical system characteristics and drawing representations, and apply the underlying theories in context.
...
Covers considerations (fitness for purpose, material availability, managing risk, factor of safety) and material families: ferrous metals (cast iron, low/medium/high carbon steel, stainless steel), non-ferrous metals (aluminium and alloys, copper, brass and bronze, nickel, zinc), thermoplastic polymers (ABS, HIPS, PLA, polycarbonate, polypropylene, PMMA/acrylic), thermosetting polymers (urea formaldehyde, melamine formaldehyde, phenol formaldehyde, epoxy resin, polyester resin), elastomers (rubber, neoprene), composites (GRP, CRP), engineering ceramics (silicon carbide, glass), and smart materials (shape memory alloys, quantum tunnelling composite, thermochromic/photochromic materials, piezoelectric crystals). Also covers standard parts (valves, sensors, piping, supports and fittings) and why companies use them instead of manufacturing their own.

## 1.11 Influence of manufacturing processes on design
...
Covers non-destructive testing (visual inspection, measurement, Go/No-Go gauges, ultrasonic testing, penetrant testing, magnetic particle inspection, X-radiography) and destructive testing (macro examination, hardness testing, tensile testing, impact tests such as Izod and Charpy). Learners need to know each method's methodology, the types of defect each detects, and the relative benefits/limitations of each.

## 1.18 Measurement equipment

Covers rules, protractors, callipers (Vernier, digital), micrometres (outside, inside, depth), gauges (go/no-go, slip, plug), dial test indicators, coordinate measuring machines (CMMs), laser scanning, and digital stress/strain machines. Learners need to know what each item measures and how it's used, its accuracy and relative limitations/benefits, and technology used to measure other mechanical characteristics such as air flow.

## 1.19 Mathematical methods for measurement and performance data
...
- **BS EN 8888 / BS 8888** - the British Standard covering technical product documentation and specification, referenced throughout for drawing conventions and annotations.
- **DFM/DFA** - Design for Manufacture / Design for Assembly, considering how easily a design can actually be manufactured or assembled.
- **Non-destructive testing (NDT)** - testing that doesn't damage or destroy the item being tested (e.g. visual inspection, ultrasonic testing), contrasted with destructive testing (e.g. tensile or impact tests) which does.
- **Smart materials** - materials that respond to external stimuli, such as shape memory alloys or piezoelectric crystals.

## Related pages

- [Occupational Specialism Overview](00-overview.md)
- [Practical Criteria](02-practical-criteria.md)
